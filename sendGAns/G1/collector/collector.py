...
def collecting_traffic(name):
    ...
    shell.execute("echo \"abcd\" | sudo -S tcpdump -i any -v -G 20 not arp and not src 10.1.0.174 and not src "
                  "127.0.0.1 and not dst 10.1.0.174 and not dst 127.0.0.1 -w data-%S.pcap")
